...
import com.mindyhsu.minweather.ui.theme.Purple80
import com.mindyhsu.minweather.utils.toCelsiusString
import java.time.format.DateTimeFormatter

@Composable
fun WeatherScreen(modifier: Modifier, data: WeatherUiModel) {
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(24.dp),
            ...
            Row(
                ...
                Text(
                    text = stringResource(
                        ...
                        data.getSunsetDateTime().format(DateTimeFormatter.ofPattern(TIME_FORMAT))
                    ), fontSize = 18.sp, fontWeight = FontWeight.Light, textAlign = TextAlign.End
                )
            }
        }
